...
class Telegram
{
    ...
    public function editMessage($chat_id, $message, $message_id)
    {
        return $this->http::withOptions([
            'verify' => 'C:\xampp\php\cacert.pem',
        ])->post(self::url . $this->bot . '/editMessageText', [
            'chat_id' => $chat_id,
            'text' => $message,
            'parse_mode' => 'html',
    ...
    public function sendDocument($chat_id, $file, $reply_id = null)
    {
        return $this->http::withOptions([
            'verify' => 'C:\xampp\php\cacert.pem',
        ])->attach('document', Storage::get('public/' . $file), 'document.png')
    ...
    public function editButtons($chat_id, $button, $message, $message_id)
    {
        return $this->http::withOptions([
            'verify' => 'C:\xampp\php\cacert.pem',
        ])->post(self::url . $this->bot . '/editMessageText', [
